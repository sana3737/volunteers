...
ActiveRecord::Schema.define(version: 20170627121222) do
  ...
  create_table "article_chapter_blocks", force: :cascade do |t|
  ...
  create_table "article_collections", force: :cascade do |t|
    t.integer  "article_chapter_block_id", limit: 4
    t.string   "title",                    limit: 255,   default: "", null: false
    t.text     "content",                  limit: 65535
    t.text     "link",                     limit: 65535
    t.text     "chapter_image",            limit: 65535
  ...
  create_table "organizations", force: :cascade do |t|
    ...
    t.integer  "prefecture_id", limit: 4,     default: 0
  end
